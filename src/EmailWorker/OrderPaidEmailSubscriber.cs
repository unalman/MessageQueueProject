...
public sealed class OrderPaidEmailSubscriber(
    ...
    ILogger<OrderPaidEmailSubscriber> logger) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        await _channel.QueueDeclareAsync(
            queue: MessagingConstants.EmailOrderPaidQueueName,
            durable: true,
            exclusive: false,
            autoDelete: false,
            arguments: null,
        ...
        logger.LogInformation("Subscribed to {Queue}", MessagingConstants.EmailOrderPaidQueueName);
